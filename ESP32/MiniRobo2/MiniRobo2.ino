...
void loop()
{
  ...
  if (packetSize)
  {
    ...
    {
      Serial2.println("5," + String(doc["motor5"]["speed"].as<int>()));
      Serial.println("5," + String(doc["motor5"]["speed"].as<int>()));
    }
    if (doc.containsKey("motor6"))
    {
      Serial2.println("6," + String(doc["motor6"]["speed"].as<int>()));
      Serial.println("6," + String(doc["motor6"]["speed"].as<int>()));
    }
    if (doc.containsKey("servo"))
    {
      Serial2.println("7," + String(doc["servo"]["angle"].as<int>()));
      Serial.println("7," + String(doc["servo"]["angle"].as<int>()));
